...
export const defaultCharacter: Character = {
  ...
  spells: [
    { spellId: "guidance", prepared: true, source: "legacy" },
    { spellId: "produce-flame", prepared: true, source: "legacy" },
    { spellId: "cure-wounds", prepared: true, source: "legacy" },
    { spellId: "entangle", prepared: false, source: "legacy" },
    { spellId: "moonbeam", prepared: true, source: "legacy" },
    { spellId: "dragons-breath", prepared: false, source: "legacy" },
    { spellId: "call-lightning", prepared: true, source: "legacy" },
  ],
  inventory: [
