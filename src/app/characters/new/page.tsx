...
export default function NewCharacterPage() {
  ...
  const [form, setForm] = useState({ name: "", race: "", className: "", subclass: "", background: "", alignment: "Unaligned", playerName: "", level: 1, hp: 10, maxHp: 10, ac: 10, speed: 30, hitDice: "1d10", proficiencyBonus: 2, abilities: defaults, notes: "", feats: [] as string[] });
