...
Options:
  --entity <spells|classes|subclasses|races|subraces|backgrounds|features|items|feats>
...
async function main() {
  ...
  if (!["spells", "classes", "subclasses", "races", "subraces", "backgrounds", "features", "items", "feats"].includes(entity)) {
